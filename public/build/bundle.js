...
var app = (function () {
    ...
    const file$4 = "src\\tabs\\info.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$4, 2, 4, 43);
    			set_style(label1, "font-size", "1.8vw");
    			attr_dev(label1, "class", "experiencenav-text");
    			add_location(label1, file$4, 3, 4, 132);
    			attr_dev(label2, "class", "voteinfo svelte-1bsi474");
    			add_location(label2, file$4, 5, 4, 505);
    			attr_dev(a0, "id", "linkLabel");
    			attr_dev(a0, "href", "https://best-minecraft-servers.co/server-thundermc.21282/vote");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 6, 44, 600);
    			attr_dev(label3, "class", "votelink svelte-1bsi474");
    			attr_dev(label3, "for", "linkLabel");
    			add_location(label3, file$4, 6, 4, 560);
    			attr_dev(a1, "id", "linkLabel");
    			attr_dev(a1, "href", "https://minecraft.buzz/vote/9541");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 7, 63, 812);
    			set_style(label4, "top", "69vh");
    			attr_dev(label4, "class", "votelink svelte-1bsi474");
    			attr_dev(label4, "for", "linkLabel");
    			add_location(label4, file$4, 7, 4, 753);
    			attr_dev(nav0, "class", "experiencenav svelte-1bsi474");
    			add_location(nav0, file$4, 1, 2, 10);
    			attr_dev(div, "class", "green-line-horizontal svelte-1bsi474");
    			add_location(div, file$4, 11, 4, 986);
    			attr_dev(label5, "class", "experiencenav-info rules-info svelte-1bsi474");
    			add_location(label5, file$4, 12, 4, 1028);
    			add_location(br0, file$4, 14, 23, 1165);
    			add_location(br1, file$4, 15, 21, 1192);
    			add_location(br2, file$4, 16, 29, 1227);
    			add_location(br3, file$4, 17, 28, 1261);
    			add_location(br4, file$4, 18, 32, 1299);
    			add_location(br5, file$4, 19, 17, 1322);
    			add_location(br6, file$4, 20, 31, 1359);
    			add_location(br7, file$4, 21, 19, 1384);
    			add_location(br8, file$4, 22, 23, 1413);
    			add_location(br9, file$4, 23, 54, 1473);
    			add_location(br10, file$4, 24, 13, 1492);
    			add_location(br11, file$4, 25, 17, 1515);
    			attr_dev(label6, "class", "experiencenav-text rules-text svelte-1bsi474");
    			add_location(label6, file$4, 13, 4, 1096);
    			attr_dev(nav1, "class", "rulesnav svelte-1bsi474");
    			add_location(nav1, file$4, 10, 2, 958);
    ...
    const file$3 = "src\\tabs\\events.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "cardimage svelte-5mmzzs");
    			...
    			attr_dev(nav0, "class", "cardimagebehind svelte-5mmzzs");
    			add_location(nav0, file$2, 2, 4, 69);
    			attr_dev(nav1, "class", "card svelte-5mmzzs");
    			add_location(nav1, file$2, 1, 2, 18);
    			attr_dev(label0, "class", "itemname svelte-5mmzzs");
    			set_style(label0, "left", /*leftlabel*/ ctx[2] + "vw");
    			add_location(label0, file$2, 6, 2, 203);
    			attr_dev(button0, "class", "buybutton svelte-5mmzzs");
    			...
    			add_location(button1, file$2, 13, 4, 712);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(nav1, "click", /*showCustomPopup*/ ctx[8], false, false, false, false),
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('verticalalign' in $$props) $$invalidate(9, verticalalign = $$props.verticalalign);
    	};
