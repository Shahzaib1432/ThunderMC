    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$4, 62, 6, 1080);
    			attr_dev(li0, "class", "svelte-jw1iz3");
    			add_location(li0, file$4, 64, 8, 1121);
    			attr_dev(li1, "class", "svelte-jw1iz3");
    			add_location(li1, file$4, 65, 8, 1166);
    			attr_dev(li2, "class", "svelte-jw1iz3");
    			add_location(li2, file$4, 66, 8, 1198);
    			attr_dev(ul0, "class", "svelte-jw1iz3");
    			add_location(ul0, file$4, 63, 6, 1107);
    			attr_dev(button0, "class", "buy-button svelte-jw1iz3");
    			add_location(button0, file$4, 68, 6, 1246);
    			attr_dev(div0, "class", "rank-card svelte-jw1iz3");
    			add_location(div0, file$4, 61, 4, 1049);
    			attr_dev(h21, "class", "svelte-jw1iz3");
    			add_location(h21, file$4, 72, 6, 1344);
    			attr_dev(li3, "class", "svelte-jw1iz3");
    			add_location(li3, file$4, 74, 8, 1387);
    			attr_dev(li4, "class", "svelte-jw1iz3");
    			add_location(li4, file$4, 75, 8, 1431);
    			attr_dev(li5, "class", "svelte-jw1iz3");
    			add_location(li5, file$4, 76, 8, 1475);
    			attr_dev(ul1, "class", "svelte-jw1iz3");
    			add_location(ul1, file$4, 73, 6, 1373);
    			attr_dev(button1, "class", "buy-button svelte-jw1iz3");
    			add_location(button1, file$4, 78, 6, 1533);
    			attr_dev(div1, "class", "rank-card svelte-jw1iz3");
    			add_location(div1, file$4, 71, 4, 1313);
    			attr_dev(div2, "class", "ranks-section svelte-jw1iz3");
    			add_location(div2, file$4, 60, 2, 1016);
    			attr_dev(html, "lang", "");
    			add_location(html, file$4, 59, 0, 998);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
